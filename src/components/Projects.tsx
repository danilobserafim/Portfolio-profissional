    ...
    <section id="projetos" className="max-w-6xl mx-auto py-20 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4 text-sm">
            Backend completo para gestão de medicamentos, histórico e automação
            de monitoramento.
          </p>
          <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-1">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-4 text-sm">
            Sistema que cruza dados de necessidades e soluções para gerar ideias
            de SaaS automaticamente.
          </p>
          <ul className="text-gray-600 dark:text-gray-400 text-sm space-y-1">
